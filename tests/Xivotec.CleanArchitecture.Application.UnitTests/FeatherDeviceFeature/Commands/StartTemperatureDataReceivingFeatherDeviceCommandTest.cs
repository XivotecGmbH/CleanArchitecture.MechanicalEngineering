...
public class StartTemperatureDataReceivingFeatherDeviceCommandTest
{
    ...
    private readonly StartTemperatureDataReceivingFeatherDeviceHandler _sut;
    private readonly FeatherDeviceFeatureTestObjects _testObjects = new();

    public StartTemperatureDataReceivingFeatherDeviceCommandTest()
    ...
    public async Task Handle_ShouldCallWriteAsync_WhenDevicePresent()
    {
        ...
        dtoWithAction.Action = FeatherDeviceActionsDto.StartTemperatureDataReceiving;
        _deviceUnitOfWork.GetDeviceService<FeatherDeviceDto>().Returns(_deviceService);

        //Act
        await _sut.Handle(new StartTemperatureDataReceivingFeatherDeviceCommand(_testObjects.FeatherDeviceDto), CancellationToken.None);
