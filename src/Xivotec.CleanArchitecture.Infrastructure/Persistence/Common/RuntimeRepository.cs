...
public abstract class RuntimeRepository<TEntity>
    : IRelationalRepository<TEntity>, IRuntimeRepository where TEntity : Entity
{
    private readonly List<TEntity> _list = [];

    /// <inheritdoc cref="IRelationalRepository{TEntity}.AddAsync(TEntity)"/>
    ...
    /// <inheritdoc cref="IRelationalRepository{TEntity}.DeleteAsync(TEntity)"/>
    ...
    /// <inheritdoc cref="IRelationalRepository{TEntity}.GetAllAsync"/>
    public async Task<List<TEntity>> GetAllAsync() => await Task.FromResult(_list);

    /// <inheritdoc cref="IRelationalRepository{TEntity}.GetByIdAsync(Guid)"/>
    ...
    /// <inheritdoc cref="IRelationalRepository{TEntity}.UpdateAsync(TEntity)"/>
