...
namespace Xivotec.CleanArchitecture.Presentation.Maui.Setup;

public static class ConfigurationSetup
{
    private const string AppSettingsFilePath = "Xivotec.CleanArchitecture.Presentation.Maui.appsettings.json";
