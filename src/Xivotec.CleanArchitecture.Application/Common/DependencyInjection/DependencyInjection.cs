...
public static class DependencyInjection
{
    ...
    /// <summary>
    /// Registers all Implementations of Interface TInterface as Scoped in the DI Container.
    /// </summary>
    /// <typeparam name="TInterface">Interface Type to register.</typeparam>
    /// <param name="services">Implicit DI Container access point.</param>
    /// <returns></returns>
    public static IServiceCollection RegisterInterfaceImplementationAsScoped<TInterface>(
        this IServiceCollection services) where TInterface : class
    {
        var assembly = Assembly.GetCallingAssembly();
        return RegisterInterfaceBase<TInterface>(assembly, services, RegistrationType.Scoped);
    }
        ...
        Type type, Type implementationType)
    {
        ...
        {
            RegistrationType.Transient => services.AddTransient(implementationType, type),
